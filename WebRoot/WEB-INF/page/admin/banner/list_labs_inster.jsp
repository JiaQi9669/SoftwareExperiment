...
<body>
	<div class="place">
		...
		<ul class="placeul">
			<li><a href="#">首页</a></li>
						<li><a href="Managelabsupdate">实验教学</a>
			</li>
			<li><a href="#">修改详情</a></li>
		</ul>
	</div>
	...
	<center>
		<form action="Managelabsinsertwrite?id=${lab.id }" method="post">
			<center style="font-size: 20px;font-style: !important;">
				请添加标题： <input type="text"
					...
					name="titles" value="${lab.titles }" />
			</center>
			<script name="context" id="editor" type="text/plain"
				style="width:1024px;height:500px;">${lab.context }</script>
