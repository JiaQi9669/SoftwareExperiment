...
<body>
	...
	<form action="Manageteacherwrite" method="post" enctype="multipart/form-data">
		...
		<div style="float:left; position:relative;top:70px;left:300px;">姓&nbsp;&nbsp;名&nbsp;&nbsp;：<input type="text" style="font-size: 20px;font-style: !important;background-color:#cceeff;" name="titles"/></div>
		<div style="float:left; position:relative;top:100px;left:24px;">职&nbsp;&nbsp;称&nbsp;&nbsp;：<input type="text" style="font-size: 20px;font-style: !important;background-color:#cceeff;" name="position"/></div>
