			...
			<div class="list_mainleft">
				<dl>
					...
					<s:iterator value="pageBean.recordList">
						<dd class="cur">
							<a class="teacherCard" href="teacherdesc?id=${id }"> 
							<img src="${pageContext.request.contextPath }/uploads/files/${path }"></img>
								<div class="TCdtl">
									<p>
										姓名：<span>${titles }</span>
									</p>
									<p>
										职称：<span>${position }</span>
									</p>
								</div> </a>
						</dd>
					</s:iterator>
					...
					<div class="outer3 outer4 outer6">
						...
						<div class="list06">
							...
							<div class="list06right list06right licon">
								<span class="a13">当前位置： <a href="viewindex">首页</a>> 师资队伍 </span>
							</div>
						</div>
						<!-- 详情 -->
						...
						<c:if test="${beans != null }">
							<div class="detail_title">
								<p class="title" style="text-align: center;">${beans.titles }</p>
								<br />
								<p style="text-align: center;">
									<span class="blue">信息来源：</span>郑轻软创&nbsp;&nbsp;&nbsp;&nbsp; <span
										class="blue">发布日期：</span><s:date name="#beans.date" format="yyyy-mm-dd hh:MM:ss"/>
